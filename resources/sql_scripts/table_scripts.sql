CREATE TABLE item_staging_table (
...
VALUES
    ...
    (122,'Delhi', '110011', 'Nikita', '2021-08-10', 'Excellent selection of items.'),
...
--item table data
INSERT INTO item (name, current_price, old_price, created_date, updated_date, expiry_date)
VALUES
    ('item1', 212, 212, '2022-05-15', NULL, '2025-01-01'),
    ('item2', 50, 50, '2021-08-10', NULL, '2025-01-01'),
    ('item3', 20, 20, '2023-03-20', NULL, '2025-01-01'),
    ('item4', 52, 52, '2020-05-05', NULL, '2025-01-01'),
    ('item5 ', 110, 110, '2022-01-15', NULL, '2025-01-01'),
    ('item6 ', 1.5, 1.5, '2021-09-25', NULL, '2025-01-01'),
    ('item7', 100, 100, '2023-07-10', NULL, '2025-01-01'),
    ('item8', 40, 40, '2020-11-30', NULL, '2025-01-01');


--transactions team table
CREATE TABLE transactions_team (
    id INT AUTO_INCREMENT PRIMARY KEY,
    first_name VARCHAR(50),
    last_name VARCHAR(50),
    manager_id INT,
...
--transactions team data
INSERT INTO transactions_team (first_name, last_name, manager_id, is_manager, address, pincode, joining_date)
VALUES
...
VALUES ('aws-pyspark-pr-1', 'active', NOW(), NOW());
...
CREATE TABLE customers_data_mart (
    ...
    address VARCHAR(200),
    phone_number VARCHAR(20),
    transactions_date_month VARCHAR(10),
    total_transactions DECIMAL(10, 2)
);


--transactions mart table
CREATE TABLE transactions_team_data_mart (
    store_id INT,
    transactions_person_id INT,
    full_name VARCHAR(255),
    transactions_month VARCHAR(10),
    total_transactions DECIMAL(10, 2),
